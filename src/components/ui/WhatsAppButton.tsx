...
export default function WhatsAppButton() {
    return (
        <Link
            ...
            className="fixed bottom-8 right-8 w-16 h-16 bg-[#25D366] text-white rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_4px_25px_rgba(37,211,102,0.6)] hover:scale-110 transition-all duration-300 flex items-center justify-center z-[100] group animate-pulse-slow"
        >
