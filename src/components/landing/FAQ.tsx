    ...
    return (
        <section id="faq" className="py-24 lg:py-32">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="font-serif text-4xl text-center text-text-main dark:text-white mb-16">
                    Preguntas Frecuentes
                </h2>

                <Accordion type="single" collapsible className="space-y-6">
                    <AccordionItem value="item-1" className="glass-card rounded-2xl border border-white/60 dark:border-gray-700 transition-all duration-300 px-6 sm:px-8 py-2 bg-white/40 dark:bg-white/5 backdrop-blur-md">
                        <AccordionTrigger className="text-lg sm:text-xl font-medium text-text-main dark:text-white hover:text-primary hover:no-underline text-left">
                            ¿Cómo funcionan los pagos desde el exterior?
                        </AccordionTrigger>
                        <AccordionContent className="text-text-main/70 dark:text-gray-400 leading-relaxed text-base pt-2 pb-6">
                    ...
                    <AccordionItem value="item-2" className="glass-card rounded-2xl border border-white/60 dark:border-gray-700 transition-all duration-300 px-6 sm:px-8 py-2 bg-white/40 dark:bg-white/5 backdrop-blur-md">
                        <AccordionTrigger className="text-lg sm:text-xl font-medium text-text-main dark:text-white hover:text-primary hover:no-underline text-left">
                    ...
                    <AccordionItem value="item-3" className="glass-card rounded-2xl border border-white/60 dark:border-gray-700 transition-all duration-300 px-6 sm:px-8 py-2 bg-white/40 dark:bg-white/5 backdrop-blur-md">
                        <AccordionTrigger className="text-lg sm:text-xl font-medium text-text-main dark:text-white hover:text-primary hover:no-underline text-left">
                    ...
                    <AccordionItem value="item-4" className="glass-card rounded-2xl border border-white/60 dark:border-gray-700 transition-all duration-300 px-6 sm:px-8 py-2 bg-white/40 dark:bg-white/5 backdrop-blur-md">
                        <AccordionTrigger className="text-lg sm:text-xl font-medium text-text-main dark:text-white hover:text-primary hover:no-underline text-left">
                ...
                <div className="mt-12 text-center">
                    <p className="text-text-main/60 dark:text-gray-400 mb-4">¿Tenés otra duda?</p>
